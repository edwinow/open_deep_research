...
class Configuration:
    ...
    document_type: str = (
        "report"  # Type of document being created (report, analysis, guide, etc.)
    )
    objective: str = ""  # Specific objective or goal of the document
    ...
    writer_model: str = (
        "claude-3-7-sonnet-latest"  # Defaults to claude-3-5-sonnet-latest
    )
